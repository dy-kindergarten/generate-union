...
<%
	...
	// 需要修改的部分
	int[] ids = {13034,13035,14134,14135,14136,14137,0,0};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img id="ele1" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:71px;top:303px;width:291px;height:71px;z-index:3;visibility:hidden">
		<img id="ele2" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:412px;top:303px;width:291px;height:71px;z-index:3;visibility:hidden">
		<img id="ele3" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:71px;top:403px;width:291px;height:71px;z-index:3;visibility:hidden">
		<img id="ele4" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:412px;top:403px;width:291px;height:71px;z-index:3;visibility:hidden">
		<img id="ele5" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:71px;top:503px;width:291px;height:71px;z-index:3;visibility:hidden">
		<img id="ele6" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:412px;top:503px;width:291px;height:71px;z-index:3;visibility:hidden">
		<img id="ele7" src="images/HD/activities/<%=abbr %>/b.png" style="position:absolute;left:930px;top:637px;width:150px;height:60px;z-index:3;visibility:hidden">
		<img id="ele8" src="images/HD/activities/<%=abbr %>/b.png" style="position:absolute;left:1105px;top:637px;width:150px;height:60px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
