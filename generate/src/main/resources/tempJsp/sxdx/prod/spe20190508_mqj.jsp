...
<%
	...
	// 需要修改的部分
	int[] ids = {10812,12939,17073,20222,12963,10782,0,0};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img id="ele1" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:304px;top:244px;width:467px;height:49px;z-index:3;visibility:hidden">
		<img id="ele2" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:790px;top:244px;width:467px;height:49px;z-index:3;visibility:hidden">
		<img id="ele3" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:304px;top:342px;width:467px;height:49px;z-index:3;visibility:hidden">
		<img id="ele4" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:790px;top:342px;width:467px;height:49px;z-index:3;visibility:hidden">
		<img id="ele5" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:304px;top:436px;width:467px;height:49px;z-index:3;visibility:hidden">
		<img id="ele6" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:790px;top:436px;width:467px;height:49px;z-index:3;visibility:hidden">
		<img id="ele7" src="images/HD/activities/<%=abbr %>/qb.png" style="position:absolute;left:704px;top:589px;width:176px;height:60px;z-index:3;visibility:hidden">
		<img id="ele8" src="images/HD/activities/<%=abbr %>/fh.png" style="position:absolute;left:910px;top:590px;width:176px;height:60px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
