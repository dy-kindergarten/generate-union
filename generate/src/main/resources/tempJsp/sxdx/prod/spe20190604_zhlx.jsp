...
<%
	...
	// 需要修改的部分
	int[] ids = {18100,20343,13877,13011,11533,18320,0,0};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img id="ele1" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:698px;top:81px;width:478px;height:78px;z-index:3;visibility:hidden">
		<img id="ele2" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:698px;top:169px;width:478px;height:78px;z-index:3;visibility:hidden">
		<img id="ele3" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:698px;top:258px;width:478px;height:78px;z-index:3;visibility:hidden">
		<img id="ele4" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:698px;top:346px;width:478px;height:78px;z-index:3;visibility:hidden">
		<img id="ele5" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:698px;top:434px;width:478px;height:78px;z-index:3;visibility:hidden">
		<img id="ele6" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:698px;top:522px;width:478px;height:78px;z-index:3;visibility:hidden">
		<img id="ele7" src="images/HD/activities/<%=abbr %>/b.png" style="position:absolute;left:706px;top:648px;width:132px;height:41px;z-index:3;visibility:hidden">
		<img id="ele8" src="images/HD/activities/<%=abbr %>/b.png" style="position:absolute;left:916px;top:648px;width:132px;height:41px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
