...
<%
	...
	// 需要修改的部分
	int[] ids = {14704,14727,14735,14738,14709,14739};
	int[] fee = {0,1,1,1,1,1};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img id="ele1" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:625px;top:170px;width:520px;height:71px;z-index:3;visibility:hidden">
		<img id="ele2" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:625px;top:245px;width:520px;height:71px;z-index:3;visibility:hidden">
		<img id="ele3" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:625px;top:320px;width:520px;height:71px;z-index:3;visibility:hidden">
		<img id="ele4" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:625px;top:395px;width:520px;height:71px;z-index:3;visibility:hidden">
		<img id="ele5" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:625px;top:470px;width:520px;height:71px;z-index:3;visibility:hidden">
		<img id="ele6" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:625px;top:545px;width:520px;height:71px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
