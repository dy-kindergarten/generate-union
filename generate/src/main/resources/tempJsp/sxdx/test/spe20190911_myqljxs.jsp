...
<%
	...
	// 需要修改的部分
	int[] ids = {10125,12178,11964,10592,11711,12879,0,0};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img src="images/HD/activities/<%=abbr %>/free.png" style="position:absolute;left:469px;top:293px;width:40px;height:46px;z-index:3;">
		<img id="ele1" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:494px;top:271px;width:339px;height:93px;z-index:3;visibility:hidden">
		<img id="ele2" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:857px;top:271px;width:339px;height:93px;z-index:3;visibility:hidden">
		<img id="ele3" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:494px;top:373px;width:339px;height:93px;z-index:3;visibility:hidden">
		<img id="ele4" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:857px;top:373px;width:339px;height:93px;z-index:3;visibility:hidden">
		<img id="ele5" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:494px;top:475px;width:339px;height:93px;z-index:3;visibility:hidden">
		<img id="ele6" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:857px;top:475px;width:339px;height:93px;z-index:3;visibility:hidden">
		<img id="ele7" src="images/HD/activities/<%=abbr %>/qb.png" style="position:absolute;left:870px;top:605px;width:170px;height:83px;z-index:3;visibility:hidden">
		<img id="ele8" src="images/HD/activities/<%=abbr %>/fh.png" style="position:absolute;left:1030px;top:605px;width:170px;height:83px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
