...
<%
	...
	// 需要修改的部分
	int[] ids = {20241,19827,16981,20513,20540,16848,20548,12818};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img id="ele7" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:906px;top:470px;width:150px;height:150px;z-index:3;visibility:hidden">
