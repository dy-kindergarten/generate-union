...
<%
	...
	// 需要修改的部分
	int[] ids = {12579,10092,10025,18415,11567,11010,0,0};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img id="ele1" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:75px;top:90px;width:594px;height:68px;z-index:3;visibility:hidden">
		<img id="ele2" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:75px;top:165px;width:594px;height:68px;z-index:3;visibility:hidden">
		<img id="ele3" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:75px;top:242px;width:594px;height:68px;z-index:3;visibility:hidden">
		<img id="ele4" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:75px;top:320px;width:594px;height:68px;z-index:3;visibility:hidden">
		<img id="ele5" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:75px;top:400px;width:594px;height:68px;z-index:3;visibility:hidden">
		<img id="ele6" src="images/HD/activities/<%=abbr %>/a.png" style="position:absolute;left:75px;top:480px;width:594px;height:68px;z-index:3;visibility:hidden">
		<img id="ele7" src="images/HD/activities/<%=abbr %>/qb.png" style="position:absolute;left:97px;top:603px;width:191px;height:51px;z-index:3;visibility:hidden">
		<img id="ele8" src="images/HD/activities/<%=abbr %>/fh.png" style="position:absolute;left:373px;top:603px;width:151px;height:51px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
