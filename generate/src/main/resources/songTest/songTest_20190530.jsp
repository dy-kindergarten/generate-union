...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img id="status" src="images/HD/common/eles/offline.png" style="position:absolute;left:526px;top:560px;width:228px;height:50px;z-index:20;display:none">
				<div style="position:fixed;left:545px;top:250px;width:150px;height:100px;z-index:2;">test2 - null</div>		<img id="ele1" src="images/HD/activities/spe20190513_xqtbql/a.png" style="position:absolute;left:545px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">		<div style="position:fixed;left:715px;top:250px;width:150px;height:100px;z-index:2;">test - null</div>		<img id="ele2" src="images/HD/activities/spe20190513_xqtbql/a.png" style="position:absolute;left:715px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
