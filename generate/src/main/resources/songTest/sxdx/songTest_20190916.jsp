...
<%
	...
	// 需要修改的部分
	int[] ids = {13034,13035,14134,14135,14136,14137};
	int[] fee = {1,1,1,1,1,1};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<img id="status" src="images/HD/common/eles/offline.png" style="position:absolute;left:526px;top:560px;width:228px;height:50px;z-index:20;display:none">
				<div style="position:fixed;left:375px;top:250px;width:150px;height:100px;z-index:2;">我把太阳迎进祖国 - 阎维文</div>		<img id="ele1" src="images/HD/activities/songTest/a.png" style="position:absolute;left:375px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">		<div style="position:fixed;left:545px;top:250px;width:150px;height:100px;z-index:2;">中华有我四季春 - 阎维文</div>		<img id="ele2" src="images/HD/activities/songTest/a.png" style="position:absolute;left:545px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">		<div style="position:fixed;left:715px;top:250px;width:150px;height:100px;z-index:2;">公务员之歌 - 阎维文</div>		<img id="ele3" src="images/HD/activities/songTest/a.png" style="position:absolute;left:715px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">		<div style="position:fixed;left:885px;top:250px;width:150px;height:100px;z-index:2;">光荣啊党的忠诚卫士 - 阎维文</div>		<img id="ele4" src="images/HD/activities/songTest/a.png" style="position:absolute;left:885px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">		<div style="position:fixed;left:375px;top:370px;width:150px;height:100px;z-index:2;">军交之歌 - 阎维文</div>		<img id="ele5" src="images/HD/activities/songTest/a.png" style="position:absolute;left:375px;top:370px;width:150px;height:100px;z-index:3;visibility:hidden">		<div style="position:fixed;left:545px;top:370px;width:150px;height:100px;z-index:2;">可亲可敬的人 - 阎维文</div>		<img id="ele6" src="images/HD/activities/songTest/a.png" style="position:absolute;left:545px;top:370px;width:150px;height:100px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
