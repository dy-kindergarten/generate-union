...
<%
	...
	// 需要修改的部分
	int[] ids = {12282,15647,11052,12722,17298,17376};
	int[] fee = {1,1,1,1,1,1};
...
<html>
	...
	<body onload="start()" bgcolor="transparent">
		...
		<div style="position:fixed;left:375px;top:250px;width:150px;height:100px;z-index:2;">半岛铁盒 - 周杰伦</div>
		<img id="ele1" src="images/HD/activities/songTest/a.png" style="position:absolute;left:375px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">
		<div style="position:fixed;left:545px;top:250px;width:150px;height:100px;z-index:2;">遇见-mv - 孙燕姿</div>
		<img id="ele2" src="images/HD/activities/songTest/a.png" style="position:absolute;left:545px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">
		<div style="position:fixed;left:715px;top:250px;width:150px;height:100px;z-index:2;">爱要怎么说出口 - 赵传</div>
		<img id="ele3" src="images/HD/activities/songTest/a.png" style="position:absolute;left:715px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">
		<div style="position:fixed;left:885px;top:250px;width:150px;height:100px;z-index:2;">月亮惹的祸 - 张宇</div>
		<img id="ele4" src="images/HD/activities/songTest/a.png" style="position:absolute;left:885px;top:250px;width:150px;height:100px;z-index:3;visibility:hidden">
		<div style="position:fixed;left:375px;top:370px;width:150px;height:100px;z-index:2;">记得-mv - 张惠妹</div>
		<img id="ele5" src="images/HD/activities/songTest/a.png" style="position:absolute;left:375px;top:370px;width:150px;height:100px;z-index:3;visibility:hidden">
		<div style="position:fixed;left:545px;top:370px;width:150px;height:100px;z-index:2;">恋人未满 - S.H.E</div>
		<img id="ele6" src="images/HD/activities/songTest/a.png" style="position:absolute;left:545px;top:370px;width:150px;height:100px;z-index:3;visibility:hidden">
		<%if(isMobile.equals("mobile")){ %>
